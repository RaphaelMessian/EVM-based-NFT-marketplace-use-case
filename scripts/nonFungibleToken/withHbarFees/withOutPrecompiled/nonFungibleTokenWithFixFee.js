//The purpose of this script is to demonstrate how to create a non fungible token with fix fees and transfer using the IERC721
...
async function main() {
    ...
    const tokenId = await createNFTWithFees(client, process.env.OPERATOR_ID, process.env.OPERATOR_KEY, process.env.FEE_COLLECTOR_ID, null, false, true);
