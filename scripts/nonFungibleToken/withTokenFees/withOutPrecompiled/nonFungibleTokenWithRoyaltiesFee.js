...
async function main() {
  ...
  console.log("Token associated to contract tx hash", associateFixFeeTokenTx.hash);
    ...
    //Transfer some fixfee token to the otherWallet that will pay for the fallback fee      
    const tranferFixFeeTokentoOtherWallet = await erc20Interface.transfer(otherWallet.address, 1e8, {gasLimit: 1_000_000});
