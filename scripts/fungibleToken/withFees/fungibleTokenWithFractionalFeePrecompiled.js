//The purpose of this script is to demonstrate how to create a fungible token with fractionnal fees using the precompiled contract
//The token is created with a fractionnal fee of 80% for the treasury account, the treasury is the contract and the contract is the supply key
...
async function main() {
    ...
    console.log("Token transfer tx hash", transferTokenToOWTx.hash);
     ...
     //Balance of the otherWallet should be 100 minus 10% of fractionnal fee
