//The purpose of this script is to demonstrate how to create a fungible token with fix fee using the precompiled contract
//The token is created with a fixed fee of 1 hbars for the feeCollector account, the treasury is the contract and the contract is the supply key
...
async function main() {
    ...
    console.log("Token transfer tx hash", transferTokenToOWTx.hash);
     ...
     console.log("Balance of feeCollector after the Transfer", feeCollectorBalanceAfterTransfer.toString());
